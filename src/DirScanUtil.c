...
void getAllFilePathRecursion(const char* Path, unsigned int* fileIndex, char** fileNames)
{
    DIR* Directory;
    struct dirent* Entries;
    if ((Directory = opendir(Path)) != NULL) 
...
char** getAllFilePaths(const char* Path, unsigned int* fileIndex)
{
...
void getAllDirectoryPathRecursion(const char* Path, unsigned int* directoryIndex, char** directoryNames)
{
    DIR* Directory;
    struct dirent* Entries;
    if ((Directory = opendir(Path)) != NULL) 
...
char** getAllDirectoryPaths(const char* Path, unsigned int* directoryIndex)
{
